...
import 'carousel_controller.dart' as ctrl;
...
class CarouselSlider extends StatefulWidget {
  ...
  final ctrl.CarouselControllerImpl _carouselController;
  ...
  CarouselSlider(
      ...
      this.disableGesture,
      ctrl.CarouselController? carouselController,
      Key? key})
      : itemBuilder = null,
        itemCount = items != null ? items.length : 0,
        _carouselController = carouselController != null
            ? carouselController as ctrl.CarouselControllerImpl
            : ctrl.CarouselController() as ctrl.CarouselControllerImpl,
        super(key: key);
...
class CarouselSliderState extends State<CarouselSlider>
  ...
  final ctrl.CarouselControllerImpl carouselController;
  Timer? timer;
